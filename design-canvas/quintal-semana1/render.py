...
def achatar(caminho):
    ...
    # Os valores saem do PROPRIO data-props, sem lista fixa de nomes aqui.
    # Antes eram dois nomes cravados com defaults 0.80/0.86 — que nem eram os
    # do gerador (0.72/0.78): artboard salvo sem props renderizava mais escuro
    # do que o editor mostrava, calado. E qualquer controle novo (o halo tem
    # dois) quebraria o render com "hole sem valor" ate alguem editar aqui.
