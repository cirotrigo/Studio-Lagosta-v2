...
export const VOZES_PROPOSTAS: Record<number, { nome: string; voz: VozCompacta }> = {
  ...
  4: {
    ...
    voz: {
      ...
      proibicoes: ['abreviar "Seu Quinto" para "Quinto"', 'preço, percentual ou combo; delivery ou CEP; qualquer contato além do Instagram', 'nomear item "do dia" (caldinho, doce, chopp convidado); inventar programação além de Samba do Canto e Almoço ao vivo', 'convite ou prova social para dia e horário em que a casa não recebe: o funcionamento vem da base, na data da peça', 'copo gelado, petisco da casa, cachaça boa, ambiente aconchegante, convivência, até tarde; imperdível, incrível, gourmet', 'empilhar benefícios; slogan; CTA fora da lista fechada'],
      regras: [
