...
export const VOZES_PROPOSTAS: Record<number, { nome: string; voz: VozCompacta }> = {
  ...
  2: {
    ...
    voz: {
      ...
      exemplos: ['Bora pro quintal?', 'A brasa tá acesa', 'Chega mais', 'Reserva sua mesa', 'Vem que tem', 'Junta a galera', 'Te esperamos aqui', 'Vem pra cá', 'DOMINGOU NO QUINTAL', 'HORA DO ALMOÇO', 'CHEGA PRA DIVIDIR'],
