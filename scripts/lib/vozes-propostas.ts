...
export const VOZES_PROPOSTAS: Record<number, { nome: string; voz: VozCompacta }> = {
  1: {
    ...
    voz: {
      ...
      proibicoes: ['as palavras promoção, sorvete, chantilly, creme de leite, corre, imperdível, última chance, barato', 'galera, bora, yummy, deliciaaa, muito gostoso, vamos estar, chave de ouro, click, quentinho', 'urgência gritada e preço como argumento', 'linguagem infantilizada', '"não é X, é Y" e pergunta retórica', 'WhatsApp, link de pedido ou botão de compra: não existem, não inventar', 'sabor, combinação ou produto fora do cardápio da base'],
      regras: [
        ...
        { id: 'regra-2026-08-16-1', texto: 'A peça de FUNCIONAMENTO leva as DUAS lojas (Praia do Canto e Shopping Vitória), uma em cada linha do rodapé; é a primeira peça do dia. As três artes do dia comunicam para ambas as unidades.', motivo: 'correção do Ciro em 16/08/2026, que substituiu a regra anterior de "uma unidade por peça"', em: '2026-08-16', escopo: 'ambas', ativa: true },
        { id: 'regra-2026-08-16-2', texto: 'Assunto exclusivo da Praia do Canto (Semifreddo de Pistache, Suco de Frutas Vermelhas) exige peça nomeando essa unidade.', motivo: 'correção do Ciro em 16/08/2026', em: '2026-08-16', escopo: 'copy', ativa: true },
  ...
  2: {
    ...
    voz: {
      ...
      exemplos: ['Bora pro quintal?', 'A brasa tá acesa', 'Chega mais', 'Reserva sua mesa', 'Vem que tem', 'Junta a galera', 'Te esperamos aqui', 'Vem pra cá', 'SEXTA É DIA DE QUINTAL', 'DOMINGOU NO QUINTAL', 'HORA DO ALMOÇO', 'CHEGA PRA DIVIDIR'],
  ...
  3: {
    ...
    voz: {
      ...
      proibicoes: ['imperdível, corre, últimas unidades, aproveita agora, maravilhoso, incrível, perfeito, demais, top, delícia, sensacional, simplesmente, que tal', 'bora, galera, vamos estar, chave de ouro, diminutivo fofo', '"brasa" e "parrilla" em copy; o nome da chef; a sigla "HH"', 'preço de cardápio (só o Happy Wine pode); rótulo, safra ou preço de vinho', 'delivery, WhatsApp, site, CEP, estacionamento; travessão', 'nomear entrada ou sobremesa do executivo; listar os drinks do happy hour', 'domingo nada noturno; segunda nada de almoço', 'CTA de deslizar ("arrasta pra ver")'],
      regras: [
        { id: 'regra-2026-08-24-1', texto: 'O happy hour não é desconto: comunica-se pela mecânica (chopp e drinks selecionados em dobro). Pré-título com percentual de OFF está revogado.', motivo: 'a mecânica mudou em 17/08/2026 e o DNA seguia listando o percentual (varredura de 24/08/2026)', em: '2026-08-24', escopo: 'copy', ativa: true },
        ...
        { id: 'regra-2026-08-31-5', texto: 'Rolha free: nome da mecânica em destaque e a janela (de segunda a quinta, no jantar), sem explicar a mecânica nem prometer condições; detalhes ficam para o Direct. A foto (taças à mesa) explica.', motivo: 'decisão do Ciro em 31/08/2026', em: '2026-08-31', escopo: 'copy', ativa: true },
        { id: 'regra-2026-09-01-1', ...COPY_CURTA },
      ],
    },
  },
  4: {
    ...
    voz: {
      ...
      exemplos: ['Venha pro boteco', 'Seu boteco favorito', 'Vem pro Seu Quinto', 'Chega no Seu Quinto', 'Já estamos abertos', 'A mesa tá reservada pra você', 'Hoje tem Seu Quinto', 'Domingou no boteco favorito', 'QUARTA É DIA DE CHOPP', 'SÁBADO DE BOTECO', 'é BOM DEMAIS!', 'Aprovadíssimo!'],
      ...
      proibicoes: ['abreviar "Seu Quinto" para "Quinto"', 'preço, percentual ou combo; delivery ou CEP; qualquer contato além do Instagram', 'nomear item "do dia" (caldinho, doce, chopp convidado); inventar programação além de Samba do Canto e Almoço ao vivo', 'sugerir jantar de domingo (a casa fecha cedo); prova social de domingo sai com a casa fechada', 'copo gelado, petisco da casa, cachaça boa, ambiente aconchegante, convivência, até tarde; imperdível, incrível, gourmet', 'empilhar benefícios; slogan; CTA fora da lista fechada'],
      regras: [
  ...
  5: {
    ...
    voz: {
      ...
      antesDepois: [{ antes: 'rodízio', depois: 'no kilo', motivo: 'a Bacana é no kilo, não rodízio' }],
  ...
  7: {
    ...
    voz: {
      ...
      exemplos: ['Reserve já', 'Peça no delivery', 'Vem pro By Rock', 'Bora!', 'Garanta sua mesa', 'Chama a galera', 'No volume máximo', 'Liga o som e abre o apetite', 'Vem almoçar', 'Chama a família e vem', 'HAPPY HOUR TODO DIA', 'QUINTA É DIA DE VINHO'],
      antesDepois: [
        { antes: 'Roberto Carlos: baby beef grelhado com a combinação do dia.', depois: 'Grelhado na hora, com a combinação do dia. É o Roberto Carlos.', motivo: 'a informação vem antes do nome temático' },
        { antes: 'os Rock Steaks', depois: 'os cortes grelhados (os Rock Steaks)', motivo: 'seção do cardápio se explica antes de nomear' },
      ],
      ...
      proibicoes: ['imperdível, delícia, top, sensacional, gourmet, requintado, corre, últimas unidades, aproveita agora, incrível, perfeito, simplesmente, demais, que tal', 'sofisticado, refinado, heavy metal, underground, vamos estar, chave de ouro', '"Não é X, é Y"; pergunta retórica de abertura; caixa alta em todos os campos; emoji dentro da arte', 'duas metáforas musicais na mesma peça; metáfora antes da informação; abrir a peça pelo nome temático do prato ou da seção', 'empilhar duas ofertas na mesma peça; "de X por Y"', 'técnica ou equipamento de preparo (brasa, chapa, forno, defumação): a casa não tem brasa, os cortes são grelhados; "chapa" só como travessa', 'a sigla HH sozinha: sempre "itens marcados com o selo HH no cardápio"'],
      regras: [
  ...
  11: {
    ...
    voz: {
      ...
      proibicoes: ['imperdível, corre, últimas unidades, aproveita agora, incrível, perfeito, top, delícia, sensacional, simplesmente, que tal, demais, ao vivo', 'bora, galera, barato, vamos estar, chave de ouro', 'urgência de relógio ("começa em", "já começou", "daqui a pouco"): usar "disponível", "acontece" e horário fixo', 'a chef anterior, em qualquer variação', 'item fora do cardápio (cervejas além da IPA, bebida sem álcool além do café expresso, Cheesecake Basca, a versão antiga do executivo)', 'travessão longo no texto do post (traço médio em faixa de horário pode)', 'CTA fora dos seis aprovados, cópia literal', 'programação em domingo'],
      regras: [{ id: 'regra-2026-09-01-1', ...COPY_CURTA }],
    },
  },
  12: {
    ...
    voz: {
      ...
      proibicoes: ['imperdível, corre, últimas unidades, aproveita agora, top, delícia, sensacional, gourmet, bora, galera', 'pergunta retórica de abertura; urgência de varejo; superlativo empilhado; chamada dupla', 'falsa intimidade; explicar a própria elegância; emoji na arte; reticências suspensivas', 'telefone (não está cadastrado); inventar número', 'convidar para segunda-feira (a casa está fechada)', 'preço do almoço executivo enquanto não estiver cadastrado na base (o do Happy Wine pode, vindo da base)'],
      regras: [
