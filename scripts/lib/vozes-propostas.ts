...
export const VOZES_PROPOSTAS: Record<number, { nome: string; voz: VozCompacta }> = {
  1: {
    ...
    voz: {
      versao: V,
      descricao: 'Premium, doce e acolhedora, com clareza acima de criatividade: elegante, precisa e afetiva. Vocabulário italianizado (gelato, panna, fior di latte) e nome de produto sempre em italiano. Fala direto, sem enigma nem urgência fabricada; sem "não é X, é Y" e sem pergunta retórica. A peça fala para todas as unidades vigentes, e só individualiza produto ou unidade quando o pedido pede. Em crise, doçura sóbria que resolve no direct.',
      tratamento: 'você / vocês, com posse afetiva: "sua pausa", "seu momento"',
      exemplos: ['Sua pausa com sabores Real', 'Pausa da tarde merece sabores Real', 'Aqueça seu dia na Real', 'Domingo Doce com Il Vero Gelato', 'Para elevar sua tarde', 'Quarta do Crepe', 'CTAs (lista fechada, cópia literal, primeira parte): Desacelere e desfrute · Desacelere e viva o Extraordinário · Porque hoje é dia de se permitir · Viva o Extraordinário', 'CTAs (lista fechada, cópia literal, segunda parte): Il vero gelato onde você estiver · Hoje você merece sabores Real! · Sua próxima parada do Passaporte Real'],
      antesDepois: [{ antes: 'meia-noite', depois: 'horário em numerais', motivo: 'o horário desta casa se escreve em numerais, nunca por extenso' }],
      ...
      proibicoes: ['as palavras promoção, sorvete, chantilly, creme de leite, corre, imperdível, última chance, barato', 'galera, bora, yummy, deliciaaa, muito gostoso, vamos estar, chave de ouro, click, quentinho', 'urgência gritada e preço como argumento', 'linguagem infantilizada', '"não é X, é Y" e pergunta retórica', 'canal de pedido ou botão de compra que a base não registra (os canais existentes vêm da base)', 'sabor, combinação ou produto fora do cardápio da base', 'os CTAs "Experimente o sabor do dia" e "Vem provar", aposentados pela equipe'],
      regras: [
        ...
        { id: 'regra-2026-08-16-2', texto: 'Assunto exclusivo de uma unidade exige peça nomeando essa unidade; quais itens são exclusivos, e de qual unidade, vem da base na data da peça.', motivo: 'correção do Ciro em 16/08/2026', em: '2026-08-16', escopo: 'copy', ativa: false },
        { id: 'regra-2026-08-16-3', texto: 'Bloco de texto que não está na copy NÃO entra na arte; a referência de estilo é estilo, nunca conteúdo (nem a foto dela, nem o rodapé de funcionamento).', motivo: 'defeito sistemático diagnosticado pela Roberta na bancada em 16/08/2026 (duas vezes na mesma peça)', em: '2026-08-16', escopo: 'arte', ativa: false },
        { id: 'regra-2026-08-16-4', texto: 'Meia-noite se escreve "meia-noite", nunca em numeral.', motivo: 'observado nas artes de sexta e sábado em 16/08/2026', em: '2026-08-16', escopo: 'copy', ativa: false },
        { id: 'regra-2026-09-13-1', texto: 'A peça fala para todas as unidades vigentes. Individualizar produto ou unidade só quando o pedido pedir.', motivo: 'correção da Roberta na revisão da voz em 13/09/2026', em: '2026-09-13', escopo: 'copy', substitui: 'regra-2026-08-16-2', ativa: true },
        { id: 'regra-2026-09-13-2', texto: 'Bloco de texto que não está na copy NÃO entra na arte: o funcionamento só aparece quando está na copy. Texto que já vem dentro da fotografia não conta como bloco. A referência de estilo é estilo, nunca conteúdo.', motivo: 'correção da Roberta na revisão da voz em 13/09/2026', em: '2026-09-13', escopo: 'arte', substitui: 'regra-2026-08-16-3', ativa: true },
        { id: 'regra-2026-09-13-3', texto: 'Horário sempre em numerais, nunca por extenso.', motivo: 'correção da Roberta na revisão da voz em 13/09/2026', em: '2026-09-13', escopo: 'copy', substitui: 'regra-2026-08-16-4', ativa: true },
  ...
  2: {
    ...
    voz: {
      ...
      exemplos: ['Bora pro quintal?', 'A brasa tá acesa', 'Chega mais', 'Junta a galera', 'A mesa é de vocês', 'Chega pra resenha', 'DOMINGOU NO QUINTAL', 'ALMOÇO É NO QUINTAL', 'HAPPY HOUR É AQUI!', 'SEXTA É NO QUINTAL', 'FIM DE SEMANA COMEÇA AQUI!', 'CHEGA PRA DIVIDIR'],
      ...
      regras: [
        ...
        { id: 'regra-2026-08-27-1', texto: 'A lista fechada de CTAs tem OITO opções: Bora pro quintal? · A brasa tá acesa · Chega mais · Reserva sua mesa · Vem que tem · Junta a galera · Te esperamos aqui · Vem pra cá. Cópia literal; CTA novo só com aprovação.', motivo: 'o Ciro trocou à mão o CTA do último slide do carrossel do Best of the Best para "Vem pra cá" em 27/08/2026 e confirmou que vale daqui para a frente', em: '2026-08-27', escopo: 'copy', substitui: 'regra-2026-08-24-1', ativa: false },
        { id: 'regra-2026-09-13-1', texto: 'A lista fechada de CTAs tem NOVE: Bora pro quintal? · A brasa tá acesa · Chega mais · Reserva sua mesa · Junta a galera · Te esperamos aqui · Vem pra cá · A mesa é de vocês · Chega pra resenha. Cópia literal; CTA novo só com aprovação.', motivo: 'revisão da voz pela Roberta em 13/09/2026: "Vem que tem" saiu, "A mesa é de vocês" e "Chega pra resenha" entraram', em: '2026-09-13', escopo: 'copy', substitui: 'regra-2026-08-27-1', ativa: true },
        { id: 'regra-2026-09-13-2', texto: 'A brasa tá acesa é assinatura da casa: só em parrilla ou corte, de preferência como manchete. Reserva sua mesa só com reserva de verdade. Te esperamos aqui com moderação, Vem pra cá no story, Chega pra dividir só com produto divisível.', motivo: 'revisão da voz pela Roberta em 13/09/2026', em: '2026-09-13', escopo: 'copy', ativa: true },
        { id: 'regra-2026-09-01-1', ...COPY_CURTA },
      ],
    },
  },
  3: {
    ...
    voz: {
      ...
      exemplos: ['CTAs (lista fechada, cópia literal): Reserve sua mesa · Venha para o Tero · Faça sua reserva · Escolha seu vinho · Vem provar · Uma experiência para os sentidos · Fale com a gente', 'Gastronomia, bons rótulos e o cenário perfeito para brindar', 'Seu fim de semana começa aqui', 'Clássicos Tero'],
      antesDepois: [
      ...
      regras: [
        { id: 'regra-2026-08-24-1', texto: 'O happy hour não é desconto: comunica-se pela MECÂNICA vigente, que é fato da base (conferido na data da peça), nunca por percentual. Pré-título com percentual de OFF está revogado.', motivo: 'a mecânica mudou em 17/08/2026 e o DNA seguia listando o percentual', em: '2026-08-24', escopo: 'copy', ativa: true },
        { id: 'regra-2026-08-28-1', texto: 'Valor de menu fechado de evento não entra na peça: no lugar, "Solicite pelo Direct" (canal a incentivar).', motivo: 'decisão do cliente: não expor valor de evento; a conversão vai para o Direct', em: '2026-08-28', escopo: 'copy', ativa: true },
        ...
        { id: 'regra-2026-08-31-5', texto: 'Rolha free: nome da mecânica em destaque e a janela em que vale (dias e período vêm da base, na data da peça), sem explicar a mecânica nem prometer condições; detalhes ficam para o Direct. A foto (taças à mesa) explica.', motivo: 'decisão do Ciro', em: '2026-08-31', escopo: 'copy', ativa: true },
        { id: 'regra-2026-09-01-1', ...COPY_CURTA },
      ],
    },
  },
  4: {
    ...
    voz: {
      ...
      exemplos: ['CTAs (lista fechada, cópia literal, primeira parte): Venha pro boteco · Seu boteco favorito · Venha para seu boteco favorito · Vem pro Seu Quinto · Chega no Seu Quinto', 'CTAs (lista fechada, cópia literal, segunda parte): Já estamos abertos · Segue o @seuquinto · Domingou no boteco favorito · A mesa tá reservada pra você · Hoje tem Seu Quinto', 'SÁBADO DE BOTECO', 'é BOM DEMAIS!', 'Aprovadíssimo!'],
  ...
  5: {
    ...
    voz: {
      ...
      exemplos: ['CTAs (lista fechada, cópia literal, primeira parte): Reserve sua mesa · Faça sua reserva pelo WhatsApp · Monte seu prato · Peça mal passado ou ao ponto', 'CTAs (lista fechada, cópia literal, segunda parte): Fale com o gerente para encomendar · Te esperamos na brasa · Esperamos você', '[DIA] PEDE AQUELE [REFEIÇÃO] BACANA', '[REFEIÇÃO] DO JEITO BACANA', 'HOJE É DIA DAQUELE [PRATO]', '[PRATO] NO PONTO PERFEITO'],
  ...
  6: {
    ...
    voz: {
      ...
      exemplos: ['CTAs (lista fechada, cópia literal, primeira parte): Chama a piazada! · Vem pra resenha! · Partiu Espeto! · Garanta seu lugar! · Vem curtir o sabor! · Vem aproveitar! · Vem matar a fome!', 'CTAs (lista fechada, cópia literal, segunda parte): Vem se servir! · Vem pro Espeto! · Sente esse sabor! · Bora pro Espeto! · Vem saborear! · Chama o pessoal! · Experimente esse sabor!', 'CTAs (lista fechada, cópia literal, terceira parte): Chama a galera! · Vem provar! · Vem petiscar! · Garanta o seu! · Vem pro boteco do Espeto! · Vem viver esse sabor!', 'SEXTOU COM ESPETO', 'DOMINGO EM FAMÍLIA'],
      antesDepois: [
  ...
  7: {
    ...
    voz: {
      ...
      exemplos: ['CTAs (lista fechada, cópia literal, primeira parte): Reserve já · Peça no delivery · Vem pro By Rock · Bora! · Garanta sua mesa · Chama a galera', 'CTAs (lista fechada, cópia literal, segunda parte): No volume máximo · Liga o som e abre o apetite · Vem almoçar · Chama a família e vem'],
      antesDepois: [
