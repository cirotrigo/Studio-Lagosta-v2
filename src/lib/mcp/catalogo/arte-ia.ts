  ...
  definirTool({
    ...
    schema: z.object({
      ...
      versaoEsperada: z
        .string()
        .optional()
        .describe('A `versao` que revisar-arte devolveu. Se a página mudou desde a revisão, nada é aplicado (VERSAO_DIVERGENTE) — revise de novo.'),
    }),
    annotations: { readOnlyHint: false, destructiveHint: false, idempotentHint: false, openWorldHint: false },
    acesso: { tipo: 'projeto' },
    superficies: ['remoto', 'local'],
